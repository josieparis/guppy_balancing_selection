...
python /lustre/home/bf299/BallerMixPlus/BalLeRMix+_v1.py  --input $INPUT_DIR/${i}_APHP.derived.frq.derived --spect APHP_maf_spect.txt --MAF --o APHP_B2_${i}_non_win_B2_maf.out --usePhysPos --rec 2.12E-06 
