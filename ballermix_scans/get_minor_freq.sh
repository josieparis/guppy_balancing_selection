...
## output dir
freqs=${MASTER}/outputs/01_raw_minor_freqs
...
for pop in ${pops[@]}
do
vcftools --gzvcf $vcf_files/${pop}.AA.tags.vcf.gz --chr chr${SLURM_ARRAY_TASK_ID} --freq --out ${freqs}/chr${SLURM_ARRAY_TASK_ID}_${pop}.minor
done
